...
to see your NextJS website in action.
      ...
      console.log(
        ...
        `${chalk.blueBright(
          `yarn scaffold-pages`
        )}: Create placeholder templates and queries for your page types
        
        `,
        `${chalk.blueBright(
          `yarn scaffold-blocks`
        )}: Create placeholder templates and fragments for your elemental blocks
        
        `,
        `${chalk.blueBright(
          `yarn generate`
        )}: Generate a types file for your graphql schema (run automatically on every build)
